...
const projects = [
  {
    id: 1,
    title: 'Natural Food Ordering System',
    ...
    image: '💬',
    color: '#00d9ff',
    tags: ['React', 'Node.js', 'Express.js', 'MongoDB', 'API Gateway', 'CSS', 'RESTful APIs'],
    stats: {},
    status: 'PRODUCTION',
    statusColor: 'gh-green',
    github: 'https://github.com/channa-sugathadasa/Food-ordering-system.git',
  ...
  {
    id: 2,
    title: 'Vehicle Service Centre Management System ',
    ...
    image: '📈',
    color: '#58a6ff',
    tags: ['MongoDB', 'Express.js', 'React', 'Node.js', 'Tailwind CSS', 'RESTful APIs', 'JWT Authentication'],
    stats: {  },
    status: 'BETA',
    statusColor: 'gh-orange',
    github: 'https://github.com/channa-sugathadasa/vehicle-service-centre-management-system.git',
    live: 'https://example.com',
    featured: true,
    difficulty: 'PROJECT',
  },
  ...
  },
  {
    ...
    image: '🛒',
    color: '#39d353',
    tags: ['React', 'Node.js', 'MongoDB', 'Express.js', 'JWT Authentication', 'Tailwind CSS','API Gateway','RESTful APIs'],
    stats: { },
    status: 'PRODUCTION',
    statusColor: 'gh-green',
    github: 'https://github.com',
